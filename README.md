# PLATEAU TwinLink（3D都市モデル、BIMモデル、空間IDを統合した都市開発支援ツール）
...
| 大分類 | 小分類 | 機能名 | 機能説明 |
| --- | --- | --- | ---- |
| Unreal Engine Editor | | デジタルツイン基盤インポート機能 | PLATEAU SDKによってUnreal Engineにインポートされた3D都市モデルの見た目の改善、最適化を行い、ツールへの組込みや実行時のツールUIの生成を行う。 |
...
|       | [3D空間ID共通ライブラリ](https://github.com/spatial-id/javascript-sdk) | 1.0.0 | 位置情報と空間IDの相互変換及び操作をするための共通ライブラリ |
|       | [shapelib](https://github.com/OSGeo/shapelib) | 1.5 | Shapefileの読み書きのためのライブラリ |

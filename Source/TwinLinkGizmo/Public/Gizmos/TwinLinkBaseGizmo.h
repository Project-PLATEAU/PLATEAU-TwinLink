...
#include "TwinLinkBaseGizmo.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FGizmoStateChangedDelegate, ETwinLinkTransformationType, GizmoType, bool, bTransformInProgress, ETwinLinkTransformationDomain, CurrentDomain);

UCLASS()
class TWINLINKGIZMO_API ATwinLinkBaseGizmo : public AActor {
    GENERATED_BODY()
...
public:
    ...
    virtual ETwinLinkTransformationType GetGizmoType() const { return ETwinLinkTransformationType::TT_NoTransform; }
    ...
    virtual FTransform GetDeltaTransform(const FVector& LookingVector, const FVector& RayStartPoint
        , const FVector& RayEvndPoint, ETwinLinkTransformationDomain Domain);
    ...
    */
    ...
    UFUNCTION(BlueprintCallable, Category = "Gizmo")
        ETwinLinkTransformationDomain GetTransformationDomain(class USceneComponent* ComponentHit) const;
...
private:
    ...
    TMap<class UShapeComponent*, ETwinLinkTransformationDomain> DomainMap;

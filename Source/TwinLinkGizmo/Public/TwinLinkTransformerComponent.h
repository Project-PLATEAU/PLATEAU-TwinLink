...
#include "TwinLinkTransformerComponent.generated.h"

UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class TWINLINKGIZMO_API UTwinLinkTransformerComponent : public UActorComponent {
    GENERATED_BODY()

public:
    // Sets default values for this component's properties
    UTwinLinkTransformerComponent();

...
#include "TwinLinkTransformerPawn.generated.h"

UENUM(BlueprintType)
enum class ETwinLinkGizmoPlacement : uint8 {
...
UCLASS()
class TWINLINKGIZMO_API ATwinLinkTransformerPawn : public APawn {
    GENERATED_BODY()

public:
    // Sets default values for this actor's properties
    ATwinLinkTransformerPawn();
...
public:
    ...
    */
    UFUNCTION(BlueprintNativeEvent, Category = "TwinLink Gizmo")
    ...
    UFUNCTION(BlueprintCallable, Category = "TwinLink Gizmo")
        void SetSpaceType(ETwinLinkSpaceType Type);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "TwinLink Gizmo")
        ETwinLinkTransformationDomain GetCurrentDomain(bool& TransformInProgress) const;
    ...
    */
     ...
     *
     * This is already called by the TwinLinkGizmo built-in Trace Functions,
    ...
    */
     ...
     */
    UFUNCTION(BlueprintNativeEvent, Category = "TwinLink Gizmo")
        void OnGizmoStateChanged(ETwinLinkTransformationType GizmoType, bool bTransformInProgress
            , ETwinLinkTransformationDomain Domain);

    virtual void OnGizmoStateChanged_Implementation(ETwinLinkTransformationType GizmoType
        , bool bTransformInProgress, ETwinLinkTransformationDomain Domain) {
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "TwinLink Gizmo")
        void SetTransformationType(ETwinLinkTransformationType TransformationType);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "TwinLink Gizmo")
        void SetSnappingEnabled(ETwinLinkTransformationType TransformationType, bool bSnappingEnabled);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "TwinLink Gizmo")
        void SetSnappingValue(ETwinLinkTransformationType TransformationType, float SnappingValue);
...
public:
    ...
    /**
     * Select Component adds a given Component to a list of components that will be used for the TwinLink Gizmo
    ...
    */
    ...
    /**
     * Select Actor adds the Actor's Root Component to a list of components that will be used for the TwinLink Gizmo
...
private:
    ...
    */
    ...
    UClass* GetGizmoClass(ETwinLinkTransformationType TransformationType) const;

    //Resets the transform to all Zeros (including Scale)
    static void ResetDeltaTransform(FTransform& Transform);

    void SetDomain(ETwinLinkTransformationDomain Domain);
...
public:
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Replicated TwinLink Gizmo")
    ...
    */
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Debug TwinLink Gizmo")
     ...
     */
    UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable, Category = "Replicated TwinLink Gizmo", meta = (DeprecatedFunction))
     ...
     * @ see ClearDomain
     */
    UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable, Category = "Replicated TwinLink Gizmo")
     ...
     * @ see ClearDomain
     */
    UFUNCTION(NetMulticast, Reliable, Category = "Replicated TwinLink Gizmo")
     ...
     */
    UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable, Category = "Replicated TwinLink Gizmo")
        void ServerSetSpaceType(ETwinLinkSpaceType Space);
     ...
     */
    UFUNCTION(NetMulticast, Reliable, Category = "Replicated TwinLink Gizmo")
        void MulticastSetSpaceType(ETwinLinkSpaceType Space);
     ...
     */
    UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable, Category = "Replicated TwinLink Gizmo")
        void ServerSetTransformationType(ETwinLinkTransformationType Transformation);
     ...
     */
    UFUNCTION(NetMulticast, Reliable, Category = "Replicated TwinLink Gizmo")
        void MulticastSetTransformationType(ETwinLinkTransformationType Transformation);
    ...
    */
     ...
     */
    UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable, Category = "Replicated TwinLink Gizmo")
        void ServerSetDomain(ETwinLinkTransformationDomain Domain);
     ...
     */
    UFUNCTION(NetMulticast, Reliable, Category = "Replicated TwinLink Gizmo")
        void MulticastSetDomain(ETwinLinkTransformationDomain Domain);
...
private:
    ...
    */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Replicated TwinLink Gizmo", meta = (AllowPrivateAccess = "true"))
...
private:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Runtime Transformations", meta = (AllowPrivateAccess = "true"))
        ETwinLinkSpaceType CurrentSpaceType;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Gizmo", meta = (AllowPrivateAccess = "true"))
        TSubclassOf<class ATwinLinkTranslationGizmo> TranslationGizmoClass;
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Gizmo", meta = (AllowPrivateAccess = "true"))
        TSubclassOf<class ATwinLinkRotationGizmo> RotationGizmoClass;
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Gizmo", meta = (AllowPrivateAccess = "true"))
        TSubclassOf<class ATwinLinkScaleGizmo> ScaleGizmoClass;

    UPROPERTY()
        TWeakObjectPtr<class ATwinLinkBaseGizmo> Gizmo;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Runtime Transformations", meta = (AllowPrivateAccess = "true"))
        ETwinLinkGizmoPlacement GizmoPlacement;

    // Var that tells which is the Current Transformation taking place
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Runtime Transformations", meta = (AllowPrivateAccess = "true"))
        ETwinLinkTransformationType CurrentTransformation;
    ...
    */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Runtime Transformations", meta = (AllowPrivateAccess = "true"))
        TMap<ETwinLinkTransformationType, float> SnappingValues;
    ...
    */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Runtime Transformations", meta = (AllowPrivateAccess = "true"))
        TMap<ETwinLinkTransformationType, bool> SnappingEnabled;

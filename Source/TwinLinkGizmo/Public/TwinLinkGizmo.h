...
#include "TwinLinkGizmo.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogTwinLinkGizmo, Log, All);

UENUM(BlueprintType)
enum class ETwinLinkTransformationType : uint8 {
...
UENUM(BlueprintType)
enum class ETwinLinkSpaceType : uint8 {
...
UENUM(BlueprintType)
enum class ETwinLinkTransformationDomain : uint8 {
...
class FTwinLinkGizmoModule : public IModuleInterface {
public:

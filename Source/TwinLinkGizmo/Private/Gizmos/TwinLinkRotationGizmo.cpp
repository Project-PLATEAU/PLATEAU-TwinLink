...
ATwinLinkRotationGizmo::ATwinLinkRotationGizmo() {
    PreviousRotationViewScale = FVector::OneVector;
}

FVector ATwinLinkRotationGizmo::CalculateGizmoSceneScale(const FVector& ReferenceLocation
...
FTransform ATwinLinkRotationGizmo::GetDeltaTransform(const FVector& LookingVector, const FVector& RayStartPoint
    , const FVector& RayEndPoint, ETwinLinkTransformationDomain Domain) {
    ...
    if (AreRaysValid()) {
        ...
        switch (Domain) {
        case ETwinLinkTransformationDomain::TD_X_Axis:planeNormal = GetActorForwardVector(); break;
        case ETwinLinkTransformationDomain::TD_Y_Axis: planeNormal = GetActorRightVector(); break;
        case ETwinLinkTransformationDomain::TD_Z_Axis: planeNormal = GetActorUpVector(); break;
        }
...
FTransform ATwinLinkRotationGizmo::GetSnappedTransform(FTransform& outCurrentAccumulatedTransform
